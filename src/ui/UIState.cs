...
/// </summary>
internal abstract record UIState
{
    /// <summary>
    ...
    internal sealed record Home(TVGuideRoot RootData, Guid ActiveChannelId, int Version) : UIState;
    ...
    internal sealed record Selection(TVGuideRoot RootData, Guid ActiveChannelId, HashSet<Guid> SelectedIds) : UIState;
    ...
    internal sealed record Error(string Message, UIState PreviousState) : UIState;
    ...
    internal sealed record Editor(TVGuideRoot RootData, Guid ActiveChannelId, Guid? SourceChannelId, TVShow? ShowToEdit) : UIState;
}